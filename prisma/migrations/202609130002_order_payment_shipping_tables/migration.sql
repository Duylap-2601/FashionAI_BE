-- Phase 1b: Add columns and tables (enum values from 202609130001 are now committed)
...
-- 2. Create refunds table (enum values are already committed from migration 1)
